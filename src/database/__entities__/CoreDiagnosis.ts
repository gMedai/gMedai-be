 ...
 *
 * This file, 'CoreDiagnosis.ts', is generated automatically from the source database schema (DBML).
...
abstract class CoreDiagnosis {
  @PrimaryColumn({ name: 'id', type: 'uuid', generated: 'uuid' })
  id: string

  @Column({ name: 'diagnosisText', type: 'varchar', nullable: true })
  diagnosisText: string

  @Column({ name: 'imageId', type: 'uuid', nullable: true })
  imageId: string
}

export default CoreDiagnosis;